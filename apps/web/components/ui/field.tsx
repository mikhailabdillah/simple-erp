...
/** biome-ignore-all lint/suspicious/noUnnecessaryConditions: <explanation> */
"use client";
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      className={cn(
        "text-start font-normal text-muted-foreground text-sm normal-case leading-normal tracking-normal group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
